...
@deprecated("Advanced.Attach.node_to_node is deprecated, it will be removed in future versions and might not function as intended.")
...
@deprecated("Advanced.Attach.mesh_to_node is deprecated, it will be removed in future versions and might not function as intended.")
...
@deprecated("Advanced.Attach.skin_to_node is deprecated, it will be removed in future versions and might not function as intended.")
...
@deprecated("Advanced.Attach.node_to_node_unsafe is deprecated, it will be removed in future versions and might not function as intended.")
...
@deprecated("Advanced.Attach.mesh_to_node_unsafe is deprecated, it will be removed in future versions and might not function as intended.")
...
@deprecated("Advanced.Attach.skin_to_node_unsafe is deprecated, it will be removed in future versions and might not function as intended.")
...
@deprecated("Advanced.Attach.skin_to_unsafe_node is deprecated, it will be removed in future versions and might not function as intended.")
...
@deprecated("Advanced.Attach.mesh_to_unsafe_node is deprecated, it will be removed in future versions and might not function as intended.")
