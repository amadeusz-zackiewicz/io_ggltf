...
@deprecated("Advanced.Util.pattern_replace_node_names is deprecated, it will be removed in future versions and might not function as intended.")
...
@deprecated("Advanced.Util.pattern_replace_mesh_names is deprecated, it will be removed in future versions and might not function as intended.")
...
@deprecated("Advanced.Util.pattern_replace_all_names is deprecated, it will be removed in future versions and might not function as intended.")
...
@deprecated("Advanced.Util.create_filter is deprecated, it will be removed in future versions and might not function as intended.")
