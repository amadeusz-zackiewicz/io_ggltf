...
class MeshInFlight():
	def __init__(self):
		...
		self.arraysColors: list[int] = -1
		self.arraysUVMaps: list[int] = -1
		self.arrayBoneIDs: int = -1
		self.arrayBoneWeights: list[int] = -1
		self.arraysShapeKeyPositions: list[int] = -1
