...
if __name__ == "__main__" and len(sys.argv) == 1:
    ...
    filePath = "//..\\..\\output\\"
    fileName = "animated_cube_timeline_markers"
    binPath = ""
    ...
    def test(bucket):
        ...
        desc = AnimationDescriber("Timeline", frameStart="timeline_start", frameEnd="timeline_end")
        desc.add_track(None, "RandomActionTrack")
